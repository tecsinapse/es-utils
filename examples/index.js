...
const removeDuplicatesTest = [{ id: 1 }, { id: 1 }, { id: 2 }];
const omitDeepTest = {
  omit: true,
  notOmit: true,
};
...
console.log(
  'omitDeepArrayWalk: ' +
    omitDeepArrayWalk(omitDeepArrayWalkTeste, 'vector').map(c => c.id)
);
console.log('flatten: ' + flatten(flattenTeste));
console.log(
  'getFirstFromSingleElementArray: ' +
    getFirstFromSingleElementArray(getFirstFromSingleElementArrayTeste)
);
console.log(
  'getAnyFromArray: ' + getAnyFromArray(getLastFromArrayOrObjectTeste)
);
console.log(
  'getLastFromArrayOrObject: ' +
    getLastFromArrayOrObject(getLastFromArrayOrObjectTeste)
);
console.log(
  'getFirstFromSingleElementArrayNotNull: ' +
    getFirstFromSingleElementArrayNotNull(
      getFirstFromSingleElementArrayNotNullTeste
    )
);
...
console.log(
  'truncateString: ' +
    truncateString(truncateStringTeste, truncateStringMaxTest)
);
console.log(
  'removeDuplicates: ' + removeDuplicates(removeDuplicatesTest, 'id')
);
